function addCss(t) {
    var e = document.head, o = document.createElement("link");
...
function antlerSettings({layout: t, color: e, background: o, font: i, header: a, textDirection: n, showSettings: s}) {
...
function changeColorStyle() {
    $("img.svg").each(function () {
        var t = jQuery(this), e = t.prop("attributes"), o = t.attr("src");
        $.get(o, function (o) {
            var i = $(o).find("svg");
        ...
        $.getScript("assets/js/lib/i18nextXHRBackend.min.js", function () {
            $.getScript("assets/js/lib/jquery-i18next.min.js", function () {
                ...
                t || (localStorage.setItem("lng", "en-US"), t = "en-US"), i18next.use(i18nextXHRBackend).init({
                    lng: t,
                    fallbackLng: "en-US",
                    backend: {loadPath: "assets/locales/{{lng}}/translations.json"}
                }, function (t, e) {
...
function settings() {
    $("#settings").load("settings.html", function (t, e, o) {
        changeColorStyle()
    })
}

function headerfooter() {
    $("#header").load("header.html", function (t, e, o) {
    ...
    }), $("#footer").load("footer.html", function (t, e, o) {
        $('#drop-lng [data-lng="' + localStorage.getItem("lng") + '"]').addClass("xpto active"), $("#drop-lng label").click(function (t) {
            t.preventDefault(), localStorage.setItem("lng", $(this).attr("data-lng")), location.reload(!0)
        }), changeColorStyle()
    })
...
function switching() {
    $(window).on("load", function () {
        var t = $("#run-switch"), e = $(".price-content .period", ".price-container");
        t.on("click", function () {
            if ($(".mo", this).toggleClass("active"), $(".an", this).toggleClass("active"), $(".month", this).toggleClass("active"), $(".switch", this).toggleClass("on"), $(".year", this).toggleClass("active"), e.hasClass("annually")) {
                ...
                e.text("year");
                for (t = 0; t <= 4; t++) $(".price-container:eq(" + t + ") .value").text(parseFloat(12 * Number($(".price-container:eq(" + t + ") .value").text())).toFixed(2)), $(".price-container:eq(" + t + ") .discount").text(parseFloat(12 * Number($(".price-container:eq(" + t + ") .discount").text())).toFixed(2))
            }
...
function scrollgoto() {
    $(".gocheck").on("click", function (t) {
        ...
        e.length && (t.preventDefault(), $("html, body").stop().animate({scrollTop: e.offset().top}, 0))
    })
}
...
function contactform() {
    $("#contactForm").on("submit", function (t) {
        $.ajax({
            type: "POST", url: "assets/php/form-process.php", data: $(this).serialize(), success: function () {
...
function livechat() {
    var t, e;
    new Date;
    t = document.createElement("script"), e = document.getElementsByTagName("script")[0], t.async = !0, t.charset = "UTF-8", t.setAttribute("crossorigin", "*"), e.parentNode.insertBefore(t, e)
}
...
function isotope() {
    $(window).on("load", function () {
        ...
        }), o = $(".featured").find(".featured-items");
        $(".sort-button-group").on("click", ".button", function () {
            if ("all" === (t = $(this).attr("data-category"))) return e.isotope({sortBy: "original-order"}), void o.css({opacity: 1});
            var i = "." + t;
            o.filter(i).css({opacity: 1}), o.not(i).css({opacity: 0}), e.isotope("updateSortData"), e.isotope({sortBy: "selectedCategory"})
...
function slick() {
    $("#slider").slick({
        ...
        responsive: [{
            breakpoint: 1200,
            settings: {arrows: !0, centerMode: !0, centerPadding: "100px", slidesToShow: 3}
        }, {
            breakpoint: 991,
            settings: {arrows: !0, centerMode: !0, centerPadding: "200px", slidesToShow: 1}
        }, {
            breakpoint: 768,
            settings: {arrows: !0, centerMode: !0, centerPadding: "150px", slidesToShow: 1}
...
function popup() {
    $(".popup-with-form").length && $(".popup-with-form").magnificPopup({
        ...
        zoom: {
            enabled: !0, navigateByImgClick: !0, duration: 300, easing: "ease-in-out", opener: function (t) {
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    prevNextButtons: !1,
    pageDots: !0
}), jQuery(".carousel").flickity({cellSelector: ".carousel-cell"}), $(document).ready(function () {
...
function initSliderUI() {
    ...
    $(".slider-ui").length && $(".slider-ui").each(function () {
        var e = $(this), o = e.find(".slider-line"), i = e.find(".slider-inp"), a = "sliderUI" + t, n = "inputUI" + t,
            s = parseInt(i.attr("data-start")), r = parseInt(i.attr("data-count-step"));
        o.attr("id", a), i.attr("id", n), t++, r = r || 300;
        var l = document.getElementById(a), c = document.getElementById(n);
        ...
        noUiSlider.create(l, {
            start: s || 1, step: 1, connect: "lower", tooltips: !0, format: {
                to: function (t) {
                    return "VPS" + t
                }, from: function (t) {
                    return t
                }
            }, range: {min: 1, max: r}, pips: {mode: "values", values: [1, 2, 3, 4, 5], density: 5, stepped: !0}
        }), l.noUiSlider.on("change", function (t, e, o, i) {
            $(this.target).closest(".sidebar").find(".circle").attr("data-percent", parseInt(o) / r * 100)
        }), l.noUiSlider.on("update", function (t, e) {
            var o, i;
            o = t[e], i = d(), $("#disk-val").html(i[o].disk), $("#cpu-val").html(i[o].cpu), $("#ram-val").html(i[o].ram), $("#setup-val").html(i[o].setup), $("#ip-val").html(i[o].ip), $("#bw-val").html(i[o].bandwith), $("#price-val").html(i[o].price), $("#priceon-val").html(i[o].priceon), $("#orderlink-val").html(i[o].orderlink), c.value = t[e], function (t) {
                var e = d();
            ...
            var e = Number(l.noUiSlider.get()), o = l.noUiSlider.steps();
            switch (o = o[0], t.which) {
                case 13:
                    l.noUiSlider.set(this.value);
                    break;
                case 38:
                    l.noUiSlider.set(e + o[1]);
                    break;
                case 40:
                    l.noUiSlider.set(e - o[0])
            }
        })
    })
}
...
function loadMenu() {
    $(".nav-menu .menu-toggle").on("click", function () {
        ...
        return $("html, body").animate({scrollTop: $($.attr(this, "href")).offset().top - 10}, 500), !1
    })
}
...
function izotope() {
    if ($(".izotope-container").length) {
        ...
        t.isotope({itemSelector: ".item", layoutMode: "masonry", masonry: {columnWidth: ".item"}})
    }
...
function selectInit() {
    $(".selectpicker").each(function () {
        var t = $(this), e = t.attr("data-class");
...
function sticky() {
    ...
    if (t.length) {
        ...
        if (e.length) {
            var o = $(window), i = t.parent().position().top;
            o.bind("scroll resize", function () {
                ...
                a < e.offset().top + -35 ? t.css({
                    ...
                    top: "auto",
                    bottom: o.height() + a - (e.offset().top + e.outerHeight(!0)) + "px"
                }) : t.css({top: -35, bottom: "auto"})
            }).scroll()
        }
    }
}
